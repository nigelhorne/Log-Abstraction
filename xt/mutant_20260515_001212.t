...
# --- SURVIVOR: NUM_BOUNDARY_790_29_< (HIGH) line 790 in _high_priority() ---
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_790_29_< line 790 in _high_priority()';
    # NOTE: new() called with no arguments as a starting point.
    # If Log::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Log::Abstraction');
    # TODO: exercise line 790 in _high_priority() to detect the mutant
    fail('NUM_BOUNDARY_790_29_<: replace with real assertion');
}
