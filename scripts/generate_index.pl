...
<html>
	<head>
	<title>Log::Abstraction Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/Log-Abstraction">
		<img src="https://img.shields.io/github/stars/nigelhorne/Log-Abstraction?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>Log::Abstraction</h1><h2>Coverage Report</h2>
<table>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/Log-Abstraction/blob/$commit_sha/";
...
my $commit_url = "https://github.com/nigelhorne/Log-Abstraction/commit/$commit_sha";
...
foreach my $file (@history_files) {
	...
	my $url = "https://github.com/nigelhorne/Log-Abstraction/commit/$sha";
...
$html .= <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/Log-Abstraction">Log-Abstraction</a></p>
